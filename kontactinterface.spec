...
Version  : 23.04.1
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.1/src/kontactinterface-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kontactinterface-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kontactinterface-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kontactinterface-23.04.1
cd %{_builddir}/kontactinterface-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684786178
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5KontactInterface.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5KontactInterface.so.5
/V3/usr/lib64/libKPim5KontactInterface.so.5.23.1
/usr/lib64/libKPim5KontactInterface.so.5
/usr/lib64/libKPim5KontactInterface.so.5.23.1
