...
Version  : 20.12.0
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.12.0/src/kontactinterface-20.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kontactinterface-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kontactinterface-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kontactinterface-20.12.0
cd %{_builddir}/kontactinterface-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607722415
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kontactinterface-20.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kontactinterface/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kontactinterface-20.12.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kontactinterface/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kontactinterface-20.12.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kontactinterface/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kontactinterface-20.12.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kontactinterface/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kontactinterface-20.12.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kontactinterface/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5KontactInterface.so.5.16.0
