...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kontactinterface-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kontactinterface-24.08.0.tar.xz.sig
...
%setup -q -n kontactinterface-24.08.0
cd %{_builddir}/kontactinterface-24.08.0
pushd ..
cp -a kontactinterface-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724513919
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KontactInterface.so.6.2.0
/usr/lib64/libKPim6KontactInterface.so.6
/usr/lib64/libKPim6KontactInterface.so.6.2.0
