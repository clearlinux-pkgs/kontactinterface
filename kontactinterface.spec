...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kontactinterface-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kontactinterface-24.08.1.tar.xz.sig
...
%setup -q -n kontactinterface-24.08.1
cd %{_builddir}/kontactinterface-24.08.1
pushd ..
cp -a kontactinterface-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726173625
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KontactInterface.so.6.2.1
/usr/lib64/libKPim6KontactInterface.so.6
/usr/lib64/libKPim6KontactInterface.so.6.2.1
