...
Version  : 19.08.3
Release  : 15
URL      : https://download.kde.org/stable/applications/19.08.3/src/kontactinterface-19.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kontactinterface-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kontactinterface-19.08.3.tar.xz.sig
...
%prep
%setup -q -n kontactinterface-19.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573175975
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kontactinterface-19.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kontactinterface/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5KontactInterface.so.5.12.3
