...
Version  : 23.04.0
Release  : 53
URL      : https://download.kde.org/stable/release-service/23.04.0/src/kontactinterface-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kontactinterface-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kontactinterface-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kontactinterface-23.04.0
cd %{_builddir}/kontactinterface-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682024560
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim5KontactInterface.so.5.23.0
