...
Version  : 19.04.3
Release  : 11
URL      : https://download.kde.org/stable/applications/19.04.3/src/kontactinterface-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kontactinterface-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kontactinterface-19.04.3.tar.xz.sig
...
%prep
%setup -q -n kontactinterface-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562878719
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5KontactInterface.so.5.11.3
